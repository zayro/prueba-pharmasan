            ...
            <div class="info-center">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <table id="TableInfo" class="table table-sm table-striped table-bordered table-hover table-condensed">
                        </table>
                        ...
                        <div class="card-body">
                            ...
                            <form id="guardar" ng-submit="enviar(tipo_envio)">
                                ...
                                <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" id="password" ng-model="form.password" ng-required="tipo_envio == 'add'" >
                                    </div>
...
<script src="../controller/reporte.js"></script>
