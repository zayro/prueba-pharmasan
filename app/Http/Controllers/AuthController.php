...
class AuthController extends Controller
{
    ...
    public function authenticate(Request $request)
    {
        ...
        $sql = "SELECT * from $from where (username =  '$user' ) ";
    ...
    public function register(Request $request)
    {
        ...
        $save['id_roles'] = $request->input('id_roles');


        $result = $this->database->insert("users", $save);
    ...
    public function actualizarUsuario(Request $request)
    {
        ...
        $set['id_roles'] = $request->input('id_roles');

        $where['id_users'] = $request->input('id_users');

        $result =  $this->database->update('users', $set, $where);
